...
<body>
    <?= $header ?>
    <div class="form_area">
        <form action="loginSignIn/signInInsert" method="post">
            ...
            <div>
                ...
                <p class="error_message" data-bind="text: password_error_message"></p>
            </div>
            <div>
                <label for="password_sub">パスワード（再入力）</label>
                <input id="password_sub" type="password" placeholder="8~15文字" data-bind="value: password_sub, valueUpdate: 'input'">
                <p class="error_message" data-bind="text: password_sub_error_message"></p>
            </div>
            <button class="submit_btn shadow" type="submit" data-bind="enable: submit_button, css: {'shadow': submit_button}">登録</button>
        </form>
    </div>
